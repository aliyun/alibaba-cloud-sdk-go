...
type Data struct {
	...
	CdrQueueEvents            []CdrQueueEventsItem `json:"CdrQueueEvents" xml:"CdrQueueEvents"`
	CdrAgentEvents            []CdrAgentEventsItem `json:"CdrAgentEvents" xml:"CdrAgentEvents"`
	AdminList                 []User               `json:"AdminList" xml:"AdminList"`
	NumberList                []PhoneNumber        `json:"NumberList" xml:"NumberList"`
	CdrIvrEvents              []CdrIvrEventsItem   `json:"CdrIvrEvents" xml:"CdrIvrEvents"`
