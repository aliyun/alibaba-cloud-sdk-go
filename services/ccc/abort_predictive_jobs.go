...
// AbortPredictiveJobs invokes the ccc.AbortPredictiveJobs API synchronously
...
// AbortPredictiveJobsWithChan invokes the ccc.AbortPredictiveJobs API asynchronously
...
// AbortPredictiveJobsWithCallback invokes the ccc.AbortPredictiveJobs API asynchronously
...
func CreateAbortPredictiveJobsRequest() (request *AbortPredictiveJobsRequest) {
	...
	request.InitWithApiInfo("CCC", "2017-07-05", "AbortPredictiveJobs", "CCC", "openAPI")
