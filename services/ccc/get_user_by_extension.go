...
// GetUserByExtension invokes the ccc.GetUserByExtension API synchronously
...
// GetUserByExtensionWithChan invokes the ccc.GetUserByExtension API asynchronously
...
// GetUserByExtensionWithCallback invokes the ccc.GetUserByExtension API asynchronously
...
func CreateGetUserByExtensionRequest() (request *GetUserByExtensionRequest) {
	...
	request.InitWithApiInfo("CCC", "2017-07-05", "GetUserByExtension", "CCC", "openAPI")
