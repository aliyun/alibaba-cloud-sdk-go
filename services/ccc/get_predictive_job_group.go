...
// GetPredictiveJobGroup invokes the ccc.GetPredictiveJobGroup API synchronously
...
// GetPredictiveJobGroupWithChan invokes the ccc.GetPredictiveJobGroup API asynchronously
...
// GetPredictiveJobGroupWithCallback invokes the ccc.GetPredictiveJobGroup API asynchronously
...
func CreateGetPredictiveJobGroupRequest() (request *GetPredictiveJobGroupRequest) {
	...
	request.InitWithApiInfo("CCC", "2017-07-05", "GetPredictiveJobGroup", "CCC", "openAPI")
