...
// QueryOrder invokes the domain.QueryOrder API synchronously
...
// QueryOrderWithChan invokes the domain.QueryOrder API asynchronously
...
// QueryOrderWithCallback invokes the domain.QueryOrder API asynchronously
...
type QueryOrderResponse struct {
	*responses.BaseResponse
	...
	OrderProducts OrderProducts `json:"OrderProducts" xml:"OrderProducts"`
}
...
func CreateQueryOrderRequest() (request *QueryOrderRequest) {
	...
	request.InitWithApiInfo("Domain", "2016-05-11", "QueryOrder", "domain", "openAPI")
