...
// CreateOrder invokes the domain.CreateOrder API synchronously
...
// CreateOrderWithChan invokes the domain.CreateOrder API asynchronously
...
// CreateOrderWithCallback invokes the domain.CreateOrder API asynchronously
...
type CreateOrderRequest struct {
	*requests.RpcRequest
	SubOrderParam *[]CreateOrderSubOrderParam `position:"Query" name:"SubOrderParam"  type:"Repeated"`
	UserClientIp  string                      `position:"Query" name:"UserClientIp"`
	Lang          string                      `position:"Query" name:"Lang"`
}

// CreateOrderSubOrderParam is a repeated param struct in CreateOrderRequest
...
func CreateCreateOrderRequest() (request *CreateOrderRequest) {
	...
	request.InitWithApiInfo("Domain", "2016-05-11", "CreateOrder", "domain", "openAPI")
