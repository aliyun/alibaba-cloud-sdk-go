...
// ChangeResourceGroup invokes the vod.ChangeResourceGroup API synchronously
...
// ChangeResourceGroupWithChan invokes the vod.ChangeResourceGroup API asynchronously
...
// ChangeResourceGroupWithCallback invokes the vod.ChangeResourceGroup API asynchronously
...
func CreateChangeResourceGroupRequest() (request *ChangeResourceGroupRequest) {
	...
	request.InitWithApiInfo("vod", "2017-03-21", "ChangeResourceGroup", "vod", "openAPI")
