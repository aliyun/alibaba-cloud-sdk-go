...
// GetJobDetail invokes the vod.GetJobDetail API synchronously
...
// GetJobDetailWithChan invokes the vod.GetJobDetail API asynchronously
...
// GetJobDetailWithCallback invokes the vod.GetJobDetail API asynchronously
...
type GetJobDetailResponse struct {
	*responses.BaseResponse
	...
	TranscodeJobDetail TranscodeJobDetail `json:"TranscodeJobDetail" xml:"TranscodeJobDetail"`
	SnapshotJobDetail  SnapshotJobDetail  `json:"SnapshotJobDetail" xml:"SnapshotJobDetail"`
	AIJobDetail        AIJobDetail        `json:"AIJobDetail" xml:"AIJobDetail"`
}
...
func CreateGetJobDetailRequest() (request *GetJobDetailRequest) {
	...
	request.InitWithApiInfo("vod", "2017-03-21", "GetJobDetail", "vod", "openAPI")
