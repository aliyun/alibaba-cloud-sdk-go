	...
	*responses.BaseResponse
	...
	AlarmList struct {
		Alarm []struct {
			...
			Period             request.Integer `json:"Period" xml:"Period"`
			Statistics         string          `json:"Statistics" xml:"Statistics"`
			ComparisonOperator string          `json:"ComparisonOperator" xml:"ComparisonOperator"`
			Threshold          string          `json:"Threshold" xml:"Threshold"`
			EvaluationCount    request.Integer `json:"EvaluationCount" xml:"EvaluationCount"`
			StartTime          request.Integer `json:"StartTime" xml:"StartTime"`
			EndTime            request.Integer `json:"EndTime" xml:"EndTime"`
			SilenceTime        request.Integer `json:"SilenceTime" xml:"SilenceTime"`
			NotifyType         request.Integer `json:"NotifyType" xml:"NotifyType"`
			Enable             request.Boolean `json:"Enable" xml:"Enable"`
