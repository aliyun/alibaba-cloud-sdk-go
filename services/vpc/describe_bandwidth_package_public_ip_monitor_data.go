...
type DescribeBandwidthPackagePublicIpMonitorDataResponse struct {
	*responses.BaseResponse
	...
	MonitorDatas struct {
		MonitorData []struct {
			RX                   request.Integer `json:"RX" xml:"RX"`
			TX                   request.Integer `json:"TX" xml:"TX"`
			ReceivedBandwidth    request.Integer `json:"ReceivedBandwidth" xml:"ReceivedBandwidth"`
			TransportedBandwidth request.Integer `json:"TransportedBandwidth" xml:"TransportedBandwidth"`
			Flow                 request.Integer `json:"Flow" xml:"Flow"`
			Bandwidth            request.Integer `json:"Bandwidth" xml:"Bandwidth"`
			Packets              request.Integer `json:"Packets" xml:"Packets"`
