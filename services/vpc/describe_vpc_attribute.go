...
type DescribeVpcAttributeResponse struct {
	*responses.BaseResponse
	...
	ClassicLinkEnabled request.Boolean `json:"ClassicLinkEnabled" xml:"ClassicLinkEnabled"`
	VSwitchIds         struct {
	...
	AssociatedCbns struct {
		AssociatedCbn []struct {
			...
			CbnOwnerUid request.Integer `json:"CbnOwnerUid" xml:"CbnOwnerUid"`
	...
	CloudResources struct {
		CloudResourceSetType []struct {
			...
			ResourceCount request.Integer `json:"ResourceCount" xml:"ResourceCount"`
