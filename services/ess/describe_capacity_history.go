	...
	*responses.BaseResponse
	...
	CapacityHistoryItems struct {
		CapacityHistoryModel []struct {
			...
			AttachedCapacity    request.Integer `json:"AttachedCapacity" xml:"AttachedCapacity"`
			AutoCreatedCapacity request.Integer `json:"AutoCreatedCapacity" xml:"AutoCreatedCapacity"`
