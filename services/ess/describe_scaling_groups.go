...
type DescribeScalingGroupsResponse struct {
	*responses.BaseResponse
	...
	ScalingGroups struct {
		ScalingGroup []struct {
			DefaultCooldown              request.Integer `json:"DefaultCooldown" xml:"DefaultCooldown"`
			MaxSize                      request.Integer `json:"MaxSize" xml:"MaxSize"`
			PendingCapacity              request.Integer `json:"PendingCapacity" xml:"PendingCapacity"`
			RemovingCapacity             request.Integer `json:"RemovingCapacity" xml:"RemovingCapacity"`
			ScalingGroupName             string          `json:"ScalingGroupName" xml:"ScalingGroupName"`
			ActiveCapacity               request.Integer `json:"ActiveCapacity" xml:"ActiveCapacity"`
			...
			TotalCapacity                request.Integer `json:"TotalCapacity" xml:"TotalCapacity"`
			MinSize                      request.Integer `json:"MinSize" xml:"MinSize"`
