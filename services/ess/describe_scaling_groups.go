...
type DescribeScalingGroupsResponse struct {
	*responses.BaseResponse
	...
	ScalingGroups struct {
		ScalingGroup []struct {
			DefaultCooldown              requests.Integer `json:"DefaultCooldown" xml:"DefaultCooldown"`
			MaxSize                      requests.Integer `json:"MaxSize" xml:"MaxSize"`
			PendingCapacity              requests.Integer `json:"PendingCapacity" xml:"PendingCapacity"`
			RemovingCapacity             requests.Integer `json:"RemovingCapacity" xml:"RemovingCapacity"`
			ScalingGroupName             string           `json:"ScalingGroupName" xml:"ScalingGroupName"`
			ActiveCapacity               requests.Integer `json:"ActiveCapacity" xml:"ActiveCapacity"`
