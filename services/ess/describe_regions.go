	...
	*responses.BaseResponse
	Regions struct {
		Region []struct {
			...
			ClassicUnavailable request.Boolean `json:"ClassicUnavailable" xml:"ClassicUnavailable"`
			VpcUnavailable     request.Boolean `json:"VpcUnavailable" xml:"VpcUnavailable"`
