	...
	*responses.BaseResponse
	...
	ScalingConfigurations struct {
		ScalingConfiguration []struct {
			...
			SystemDiskSize              request.Integer `json:"SystemDiskSize" xml:"SystemDiskSize"`
			LifecycleState              string          `json:"LifecycleState" xml:"LifecycleState"`
			CreationTime                string          `json:"CreationTime" xml:"CreationTime"`
			LoadBalancerWeight          request.Integer `json:"LoadBalancerWeight" xml:"LoadBalancerWeight"`
