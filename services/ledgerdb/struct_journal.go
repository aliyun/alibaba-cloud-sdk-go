...
type Journal struct {
	...
	JournalHash       string   `json:"JournalHash" xml:"JournalHash"`
	...
	PayloadJsonString string   `json:"PayloadJsonString" xml:"PayloadJsonString"`
	Clues             []string `json:"Clues" xml:"Clues"`
}
