...
type MarketplaceMetadata struct {
	SpecificationMappings    []SpecificationMappingsItem    `json:"SpecificationMappings" xml:"SpecificationMappings"`
	MeteringEntityMappings   []MeteringEntityMappingsItem   `json:"MeteringEntityMappings" xml:"MeteringEntityMappings"`
