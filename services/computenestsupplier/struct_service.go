...
type Service struct {
	...
	ResellApplyStatus                string        `json:"ResellApplyStatus" xml:"ResellApplyStatus"`
	...
	LatestResellSourceServiceVersion string        `json:"LatestResellSourceServiceVersion" xml:"LatestResellSourceServiceVersion"`
	...
	ResellServiceId                  string        `json:"ResellServiceId" xml:"ResellServiceId"`
	...
	HasDraft                         bool          `json:"HasDraft" xml:"HasDraft"`
	...
	HasBeta                          bool          `json:"HasBeta" xml:"HasBeta"`
