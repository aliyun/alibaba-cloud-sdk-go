...
type CustomImage struct {
	...
	RequiredSystemDiskSize int      `json:"RequiredSystemDiskSize" xml:"RequiredSystemDiskSize"`
	RequiredDataDiskSize   int      `json:"RequiredDataDiskSize" xml:"RequiredDataDiskSize"`
	SourceImageName        string   `json:"SourceImageName" xml:"SourceImageName"`
	SourceImageVersion     string   `json:"SourceImageVersion" xml:"SourceImageVersion"`
