	...
	*responses.BaseResponse
	...
	JobList       struct {
		Job []struct {
			...
			Percent      request.Integer `json:"Percent" xml:"Percent"`
			...
			Output struct {
				...
				M3U8NonStandardSupport struct {
					TS struct {
						Md5Support  request.Boolean `json:"Md5Support" xml:"Md5Support"`
						SizeSupport request.Boolean `json:"SizeSupport" xml:"SizeSupport"`
					} `json:"TS" xml:"TS"`
				...
				TailSlateList struct {
					Merge []struct {
						...
						Width         string          `json:"Width" xml:"Width"`
						Height        string          `json:"Height" xml:"Height"`
						IsMergeAudio  request.Boolean `json:"IsMergeAudio" xml:"IsMergeAudio"`
