...
// SparkEngineConfig is a nested struct in openanalytics_open response
type SparkEngineConfig struct {
	SparkModuleReleaseName  string `json:"SparkModuleReleaseName" xml:"SparkModuleReleaseName"`
