...
// CreateServiceLinkedRole invokes the openanalytics_open.CreateServiceLinkedRole API synchronously
...
// CreateServiceLinkedRoleWithChan invokes the openanalytics_open.CreateServiceLinkedRole API asynchronously
...
// CreateServiceLinkedRoleWithCallback invokes the openanalytics_open.CreateServiceLinkedRole API asynchronously
...
func CreateCreateServiceLinkedRoleRequest() (request *CreateServiceLinkedRoleRequest) {
	...
	request.InitWithApiInfo("openanalytics-open", "2018-06-19", "CreateServiceLinkedRole", "openanalytics", "openAPI")
