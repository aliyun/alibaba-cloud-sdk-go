...
type GetOnlineStaTimeSerRequest struct {
	*requests.RpcRequest
	...
	ZoomEnd   string `position:"Query" name:"ZoomEnd"`
	Start     string `position:"Query" name:"Start"`
	ZoomStart string `position:"Query" name:"ZoomStart"`
...
func CreateGetOnlineStaTimeSerRequest() (request *GetOnlineStaTimeSerRequest) {
	...
	request.InitWithApiInfo("cloudwf", "2017-03-28", "GetOnlineStaTimeSer", "", "")
	return
}
