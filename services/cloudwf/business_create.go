...
type BusinessCreateRequest struct {
	*requests.RpcRequest
	...
	BusinessSubtype  string `position:"Query" name:"BusinessSubtype"`
	...
	BusinessTopType  string `position:"Query" name:"BusinessTopType"`
...
func CreateBusinessCreateRequest() (request *BusinessCreateRequest) {
	...
	request.InitWithApiInfo("cloudwf", "2017-03-28", "BusinessCreate", "", "")
	return
}
