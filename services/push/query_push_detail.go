...
type QueryPushDetailResponse struct {
	*responses.BaseResponse
	...
	AppKey                         request.Integer `json:"AppKey" xml:"AppKey"`
	...
	AntiHarassStartTime            request.Integer `json:"AntiHarassStartTime" xml:"AntiHarassStartTime"`
	AntiHarassDuration             request.Integer `json:"AntiHarassDuration" xml:"AntiHarassDuration"`
	StoreOffline                   request.Boolean `json:"StoreOffline" xml:"StoreOffline"`
	...
	IOSRemind                      request.Boolean `json:"iOSRemind" xml:"iOSRemind"`
	IOSRemindBody                  string          `json:"iOSRemindBody" xml:"iOSRemindBody"`
	IOSBadge                       request.Integer `json:"iOSBadge" xml:"iOSBadge"`
	...
	IOSMutableContent              request.Boolean `json:"iOSMutableContent" xml:"iOSMutableContent"`
	...
	AndroidNotificationBarType     request.Integer `json:"AndroidNotificationBarType" xml:"AndroidNotificationBarType"`
	AndroidNotificationBarPriority request.Integer `json:"AndroidNotificationBarPriority" xml:"AndroidNotificationBarPriority"`
	...
	SmsDelaySecs                   request.Integer `json:"SmsDelaySecs" xml:"SmsDelaySecs"`
	SmsSendPolicy                  request.Integer `json:"SmsSendPolicy" xml:"SmsSendPolicy"`
}
