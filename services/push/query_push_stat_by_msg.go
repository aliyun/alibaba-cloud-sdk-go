	...
	*responses.BaseResponse
	...
	PushStats struct {
		PushStat []struct {
			...
			AcceptCount            request.Integer `json:"AcceptCount" xml:"AcceptCount"`
			SentCount              request.Integer `json:"SentCount" xml:"SentCount"`
			ReceivedCount          request.Integer `json:"ReceivedCount" xml:"ReceivedCount"`
			OpenedCount            request.Integer `json:"OpenedCount" xml:"OpenedCount"`
			DeletedCount           request.Integer `json:"DeletedCount" xml:"DeletedCount"`
			SmsSentCount           request.Integer `json:"SmsSentCount" xml:"SmsSentCount"`
			SmsSkipCount           request.Integer `json:"SmsSkipCount" xml:"SmsSkipCount"`
			SmsFailedCount         request.Integer `json:"SmsFailedCount" xml:"SmsFailedCount"`
			SmsReceiveSuccessCount request.Integer `json:"SmsReceiveSuccessCount" xml:"SmsReceiveSuccessCount"`
			SmsReceiveFailedCount  request.Integer `json:"SmsReceiveFailedCount" xml:"SmsReceiveFailedCount"`
