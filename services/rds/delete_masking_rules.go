...
// DeleteMaskingRules invokes the rds.DeleteMaskingRules API synchronously
...
// DeleteMaskingRulesWithChan invokes the rds.DeleteMaskingRules API asynchronously
...
// DeleteMaskingRulesWithCallback invokes the rds.DeleteMaskingRules API asynchronously
...
func CreateDeleteMaskingRulesRequest() (request *DeleteMaskingRulesRequest) {
	...
	request.InitWithApiInfo("Rds", "2014-08-15", "DeleteMaskingRules", "rds", "openAPI")
