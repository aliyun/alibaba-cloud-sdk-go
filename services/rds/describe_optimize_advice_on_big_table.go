...
type DescribeOptimizeAdviceOnBigTableResponse struct {
	*responses.BaseResponse
	...
	TotalRecordsCount request.Integer `json:"TotalRecordsCount" xml:"TotalRecordsCount"`
	...
	Items             struct {
		AdviceOnBigTable []struct {
			...
			TableSize request.Integer `json:"TableSize" xml:"TableSize"`
			DataSize  request.Integer `json:"DataSize" xml:"DataSize"`
			IndexSize request.Integer `json:"IndexSize" xml:"IndexSize"`
