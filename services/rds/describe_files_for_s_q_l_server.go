	...
	*responses.BaseResponse
	...
	Items            struct {
		SQLServerUploadFile []struct {
			...
			FileSize          request.Integer `json:"FileSize" xml:"FileSize"`
			InternetFtpServer string          `json:"InternetFtpServer" xml:"InternetFtpServer"`
			InternetPort      request.Integer `json:"InternetPort" xml:"InternetPort"`
			IntranetFtpserver string          `json:"IntranetFtpserver" xml:"IntranetFtpserver"`
			Intranetport      request.Integer `json:"Intranetport" xml:"Intranetport"`
