	...
	*responses.BaseResponse
	...
	Items     struct {
		DBInstanceAttribute []struct {
			...
			DBInstanceMemory            requests.Integer `json:"DBInstanceMemory" xml:"DBInstanceMemory"`
			DBInstanceStorage           requests.Integer `json:"DBInstanceStorage" xml:"DBInstanceStorage"`
			...
			DBMaxQuantity               requests.Integer `json:"DBMaxQuantity" xml:"DBMaxQuantity"`
			AccountMaxQuantity          requests.Integer `json:"AccountMaxQuantity" xml:"AccountMaxQuantity"`
			...
			MaxIOPS                     requests.Integer `json:"MaxIOPS" xml:"MaxIOPS"`
			MaxConnections              requests.Integer `json:"MaxConnections" xml:"MaxConnections"`
