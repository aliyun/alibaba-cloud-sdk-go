...
// DescribeHistoryTasksStat invokes the rds.DescribeHistoryTasksStat API synchronously
func (client *Client) DescribeHistoryTasksStat(request *DescribeHistoryTasksStatRequest) (response *DescribeHistoryTasksStatResponse, err error) {
	response = CreateDescribeHistoryTasksStatResponse()
	err = client.DoAction(request, response)
	return
}

// DescribeHistoryTasksStatWithChan invokes the rds.DescribeHistoryTasksStat API asynchronously
func (client *Client) DescribeHistoryTasksStatWithChan(request *DescribeHistoryTasksStatRequest) (<-chan *DescribeHistoryTasksStatResponse, <-chan error) {
	responseChan := make(chan *DescribeHistoryTasksStatResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeHistoryTasksStat(request)
		if err != nil {
			errChan <- err
		} else {
...
// DescribeHistoryTasksStatWithCallback invokes the rds.DescribeHistoryTasksStat API asynchronously
func (client *Client) DescribeHistoryTasksStatWithCallback(request *DescribeHistoryTasksStatRequest, callback func(response *DescribeHistoryTasksStatResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeHistoryTasksStatResponse
		var err error
		defer close(result)
		response, err = client.DescribeHistoryTasksStat(request)
...
func CreateDescribeHistoryTasksStatRequest() (request *DescribeHistoryTasksStatRequest) {
	...
	request.InitWithApiInfo("Rds", "2014-08-15", "DescribeHistoryTasksStat", "rds", "openAPI")
...
func CreateDescribeHistoryTasksStatResponse() (response *DescribeHistoryTasksStatResponse) {
	response = &DescribeHistoryTasksStatResponse{
