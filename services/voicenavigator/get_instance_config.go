...
// GetInstanceConfig invokes the voicenavigator.GetInstanceConfig API synchronously
...
// GetInstanceConfigWithChan invokes the voicenavigator.GetInstanceConfig API asynchronously
...
// GetInstanceConfigWithCallback invokes the voicenavigator.GetInstanceConfig API asynchronously
...
func CreateGetInstanceConfigRequest() (request *GetInstanceConfigRequest) {
	...
	request.InitWithApiInfo("VoiceNavigator", "2018-06-12", "GetInstanceConfig", "voicebot", "openAPI")
