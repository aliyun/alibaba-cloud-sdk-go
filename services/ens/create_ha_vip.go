...
// CreateHaVip invokes the ens.CreateHaVip API synchronously
...
// CreateHaVipWithChan invokes the ens.CreateHaVip API asynchronously
...
// CreateHaVipWithCallback invokes the ens.CreateHaVip API asynchronously
...
type CreateHaVipResponse struct {
	*responses.BaseResponse
	...
	HaVipIds  []string `json:"HaVipIds" xml:"HaVipIds"`
}
...
func CreateCreateHaVipRequest() (request *CreateHaVipRequest) {
	...
	request.InitWithApiInfo("Ens", "2017-11-10", "CreateHaVip", "ens", "openAPI")
