...
type CreateInstanceRequest struct {
	*requests.RpcRequest
	...
	DataDisk1Size      string           `position:"Query"`
	Quantity           string           `position:"Query"`
	IpType             string           `position:"Query"`
	SystemDiskSize     string           `position:"Query"`
	PaymentType        string           `position:"Query"`
}
