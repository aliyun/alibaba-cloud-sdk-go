...
// DeleteLoadBalancer invokes the ens.DeleteLoadBalancer API synchronously
...
// DeleteLoadBalancerWithChan invokes the ens.DeleteLoadBalancer API asynchronously
...
// DeleteLoadBalancerWithCallback invokes the ens.DeleteLoadBalancer API asynchronously
...
func CreateDeleteLoadBalancerRequest() (request *DeleteLoadBalancerRequest) {
	...
	request.InitWithApiInfo("Ens", "2017-11-10", "DeleteLoadBalancer", "ens", "openAPI")
