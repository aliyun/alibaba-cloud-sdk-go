...
// CheckServiceLinkedRoleForDeleting invokes the xtrace.CheckServiceLinkedRoleForDeleting API synchronously
...
// CheckServiceLinkedRoleForDeletingWithChan invokes the xtrace.CheckServiceLinkedRoleForDeleting API asynchronously
...
// CheckServiceLinkedRoleForDeletingWithCallback invokes the xtrace.CheckServiceLinkedRoleForDeleting API asynchronously
...
func CreateCheckServiceLinkedRoleForDeletingRequest() (request *CheckServiceLinkedRoleForDeletingRequest) {
	...
	request.InitWithApiInfo("xtrace", "2019-08-08", "CheckServiceLinkedRoleForDeleting", "", "")
