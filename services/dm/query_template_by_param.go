	...
	*responses.BaseResponse
	...
	Data       struct {
		Template []struct {
			...
			TemplateType    request.Integer `json:"TemplateType" xml:"TemplateType"`
			SmsTemplateCode request.Integer `json:"SmsTemplateCode" xml:"SmsTemplateCode"`
			Smsrejectinfo   request.Integer `json:"Smsrejectinfo" xml:"Smsrejectinfo"`
			SmsStatus       request.Integer `json:"SmsStatus" xml:"SmsStatus"`
