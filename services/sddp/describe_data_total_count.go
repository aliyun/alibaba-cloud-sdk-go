...
// DescribeDataTotalCount invokes the sddp.DescribeDataTotalCount API synchronously
...
// DescribeDataTotalCountWithChan invokes the sddp.DescribeDataTotalCount API asynchronously
...
// DescribeDataTotalCountWithCallback invokes the sddp.DescribeDataTotalCount API asynchronously
...
func CreateDescribeDataTotalCountRequest() (request *DescribeDataTotalCountRequest) {
	...
	request.InitWithApiInfo("Sddp", "2019-01-03", "DescribeDataTotalCount", "", "")
