...
// api document: https://help.aliyun.com/api/das/describediagnosticreportlist.html
...
func CreateDescribeDiagnosticReportListRequest() (request *DescribeDiagnosticReportListRequest) {
	...
	request.InitWithApiInfo("DAS", "2020-01-16", "DescribeDiagnosticReportList", "hdm", "openAPI")
