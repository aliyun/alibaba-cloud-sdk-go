...
type InstanceAttribute struct {
	...
	InstanceCidrBlock          string                     `json:"InstanceCidrBlock" xml:"InstanceCidrBlock"`
	ConnectVpcId               string                     `json:"ConnectVpcId" xml:"ConnectVpcId"`
	InstanceClusterId          string                     `json:"InstanceClusterId" xml:"InstanceClusterId"`
	MaintainStartTime          string                     `json:"MaintainStartTime" xml:"MaintainStartTime"`
	MaintainEndTime            string                     `json:"MaintainEndTime" xml:"MaintainEndTime"`
	ConnectCidrBlocks          string                     `json:"ConnectCidrBlocks" xml:"ConnectCidrBlocks"`
	InstanceSpecAttributes     InstanceSpecAttributes     `json:"InstanceSpecAttributes" xml:"InstanceSpecAttributes"`
	NetworkInterfaceAttributes NetworkInterfaceAttributes `json:"NetworkInterfaceAttributes" xml:"NetworkInterfaceAttributes"`
}
