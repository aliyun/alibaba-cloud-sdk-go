...
type ConfigureDtsJobRequest struct {
	*requests.RpcRequest
	...
	DestinationEndpointOwnerID      string           `position:"Query" name:"DestinationEndpointOwnerID"`
	DelayPhone                      string           `position:"Query" name:"DelayPhone"`
	DtsBisLabel                     string           `position:"Query" name:"DtsBisLabel"`
	...
	DestinationEndpointRole         string           `position:"Query" name:"DestinationEndpointRole"`
	...
	SourceEndpointVSwitchID         string           `position:"Query" name:"SourceEndpointVSwitchID"`
