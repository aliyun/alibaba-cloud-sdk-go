...
type DescribePreCheckStatusResponse struct {
	*responses.BaseResponse
	...
	AnalysisJobProgress     []AnalysisProgressInfo        `json:"AnalysisJobProgress" xml:"AnalysisJobProgress"`
	SubDistributedJobStatus []SubDistributedJobStatusItem `json:"SubDistributedJobStatus" xml:"SubDistributedJobStatus"`
	FullNetCheckJobStatus   []FullNetCheckJobStatusItem   `json:"FullNetCheckJobStatus" xml:"FullNetCheckJobStatus"`
}
