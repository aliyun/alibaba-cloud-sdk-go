...
// ModifyDBInstanceMaintainTime invokes the polardbx.ModifyDBInstanceMaintainTime API synchronously
...
// ModifyDBInstanceMaintainTimeWithChan invokes the polardbx.ModifyDBInstanceMaintainTime API asynchronously
...
// ModifyDBInstanceMaintainTimeWithCallback invokes the polardbx.ModifyDBInstanceMaintainTime API asynchronously
...
func CreateModifyDBInstanceMaintainTimeRequest() (request *ModifyDBInstanceMaintainTimeRequest) {
	...
	request.InitWithApiInfo("polardbx", "2020-02-02", "ModifyDBInstanceMaintainTime", "polardbx", "openAPI")
