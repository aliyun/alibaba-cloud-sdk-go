...
// DescribeModifyParameterLog invokes the polardbx.DescribeModifyParameterLog API synchronously
...
// DescribeModifyParameterLogWithChan invokes the polardbx.DescribeModifyParameterLog API asynchronously
...
// DescribeModifyParameterLogWithCallback invokes the polardbx.DescribeModifyParameterLog API asynchronously
...
type DescribeModifyParameterLogResponse struct {
	*responses.BaseResponse
	...
	ChangeLogs []ChangeLog `json:"ChangeLogs" xml:"ChangeLogs"`
}
...
func CreateDescribeModifyParameterLogRequest() (request *DescribeModifyParameterLogRequest) {
	...
	request.InitWithApiInfo("polardbx", "2020-02-02", "DescribeModifyParameterLog", "polardbx", "openAPI")
