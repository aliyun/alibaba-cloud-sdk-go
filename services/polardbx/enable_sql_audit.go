...
// EnableSqlAudit invokes the polardbx.EnableSqlAudit API synchronously
...
// EnableSqlAuditWithChan invokes the polardbx.EnableSqlAudit API asynchronously
...
// EnableSqlAuditWithCallback invokes the polardbx.EnableSqlAudit API asynchronously
...
type EnableSqlAuditRequest struct {
	*requests.RpcRequest
	...
	ExpireAfterDays requests.Integer `position:"Query" name:"ExpireAfterDays"`
}
...
func CreateEnableSqlAuditRequest() (request *EnableSqlAuditRequest) {
	...
	request.InitWithApiInfo("polardbx", "2020-02-02", "EnableSqlAudit", "polardbx", "openAPI")
