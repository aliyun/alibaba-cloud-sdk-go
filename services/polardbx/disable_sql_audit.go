...
// DisableSqlAudit invokes the polardbx.DisableSqlAudit API synchronously
...
// DisableSqlAuditWithChan invokes the polardbx.DisableSqlAudit API asynchronously
...
// DisableSqlAuditWithCallback invokes the polardbx.DisableSqlAudit API asynchronously
...
func CreateDisableSqlAuditRequest() (request *DisableSqlAuditRequest) {
	...
	request.InitWithApiInfo("polardbx", "2020-02-02", "DisableSqlAudit", "polardbx", "openAPI")
