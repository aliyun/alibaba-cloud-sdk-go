	...
	*responses.BaseResponse
	...
	Disks      struct {
		Disk []struct {
			...
			Portable                      request.Boolean `json:"Portable" xml:"Portable"`
			Status                        string          `json:"Status" xml:"Status"`
			InstanceId                    string          `json:"InstanceId" xml:"InstanceId"`
			Device                        string          `json:"Device" xml:"Device"`
			DeleteWithInstance            request.Boolean `json:"DeleteWithInstance" xml:"DeleteWithInstance"`
			DeleteAutoSnapshot            request.Boolean `json:"DeleteAutoSnapshot" xml:"DeleteAutoSnapshot"`
			EnableAutoSnapshot            request.Boolean `json:"EnableAutoSnapshot" xml:"EnableAutoSnapshot"`
			EnableAutomatedSnapshotPolicy request.Boolean `json:"EnableAutomatedSnapshotPolicy" xml:"EnableAutomatedSnapshotPolicy"`
			...
			Encrypted                     request.Boolean `json:"Encrypted" xml:"Encrypted"`
			MountInstanceNum              request.Integer `json:"MountInstanceNum" xml:"MountInstanceNum"`
			IOPS                          request.Integer `json:"IOPS" xml:"IOPS"`
