	...
	*responses.BaseResponse
	...
	Images     struct {
		Image []struct {
			...
			IsSupportIoOptimized request.Boolean `json:"IsSupportIoOptimized" xml:"IsSupportIoOptimized"`
			IsSupportCloudinit   request.Boolean `json:"IsSupportCloudinit" xml:"IsSupportCloudinit"`
			OSName               string          `json:"OSName" xml:"OSName"`
			Architecture         string          `json:"Architecture" xml:"Architecture"`
			Status               string          `json:"Status" xml:"Status"`
			ProductCode          string          `json:"ProductCode" xml:"ProductCode"`
			IsSubscribed         request.Boolean `json:"IsSubscribed" xml:"IsSubscribed"`
			CreationTime         string          `json:"CreationTime" xml:"CreationTime"`
			IsSelfShared         string          `json:"IsSelfShared" xml:"IsSelfShared"`
			OSType               string          `json:"OSType" xml:"OSType"`
			Platform             string          `json:"Platform" xml:"Platform"`
			Usage                string          `json:"Usage" xml:"Usage"`
			IsCopied             request.Boolean `json:"IsCopied" xml:"IsCopied"`
