...
type DescribeHaVipsResponse struct {
	*responses.BaseResponse
	...
	HaVips     []struct {
		...
		AssociatedInstances    []string `json:"AssociatedInstances" xml:"AssociatedInstances"`
		AssociatedEipAddresses []string `json:"AssociatedEipAddresses" xml:"AssociatedEipAddresses"`
