	...
	*responses.BaseResponse
	...
	MonitorData struct {
		InstanceMonitorData []struct {
			...
			IntranetRX        request.Integer `json:"IntranetRX" xml:"IntranetRX"`
			IntranetTX        request.Integer `json:"IntranetTX" xml:"IntranetTX"`
			IntranetBandwidth request.Integer `json:"IntranetBandwidth" xml:"IntranetBandwidth"`
			InternetRX        request.Integer `json:"InternetRX" xml:"InternetRX"`
			InternetTX        request.Integer `json:"InternetTX" xml:"InternetTX"`
			InternetBandwidth request.Integer `json:"InternetBandwidth" xml:"InternetBandwidth"`
			...
			CPUCreditUsage    request.Float   `json:"CPUCreditUsage" xml:"CPUCreditUsage"`
			CPUCreditBalance  request.Float   `json:"CPUCreditBalance" xml:"CPUCreditBalance"`
