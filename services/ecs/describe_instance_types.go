	...
	*responses.BaseResponse
	...
	InstanceTypes struct {
		InstanceType []struct {
			...
			CpuCoreCount         request.Integer `json:"CpuCoreCount" xml:"CpuCoreCount"`
			MemorySize           request.Float   `json:"MemorySize" xml:"MemorySize"`
			...
			InitialCredit        request.Integer `json:"InitialCredit" xml:"InitialCredit"`
			BaselineCredit       request.Integer `json:"BaselineCredit" xml:"BaselineCredit"`
