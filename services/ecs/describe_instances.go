	...
	*responses.BaseResponse
	...
	Instances  struct {
		Instance []struct {
			...
			Cpu                     request.Integer `json:"Cpu" xml:"Cpu"`
			Memory                  request.Integer `json:"Memory" xml:"Memory"`
			HostName                string          `json:"HostName" xml:"HostName"`
			Status                  string          `json:"Status" xml:"Status"`
			SerialNumber            string          `json:"SerialNumber" xml:"SerialNumber"`
			InternetChargeType      string          `json:"InternetChargeType" xml:"InternetChargeType"`
			InternetMaxBandwidthIn  request.Integer `json:"InternetMaxBandwidthIn" xml:"InternetMaxBandwidthIn"`
			InternetMaxBandwidthOut request.Integer `json:"InternetMaxBandwidthOut" xml:"InternetMaxBandwidthOut"`
			...
			IoOptimized             request.Boolean `json:"IoOptimized" xml:"IoOptimized"`
			DeviceAvailable         request.Boolean `json:"DeviceAvailable" xml:"DeviceAvailable"`
			InstanceTypeFamily      string          `json:"InstanceTypeFamily" xml:"InstanceTypeFamily"`
			LocalStorageCapacity    request.Integer `json:"LocalStorageCapacity" xml:"LocalStorageCapacity"`
			LocalStorageAmount      request.Integer `json:"LocalStorageAmount" xml:"LocalStorageAmount"`
			GPUAmount               request.Integer `json:"GPUAmount" xml:"GPUAmount"`
			GPUSpec                 string          `json:"GPUSpec" xml:"GPUSpec"`
			SpotStrategy            string          `json:"SpotStrategy" xml:"SpotStrategy"`
			SpotPriceLimit          request.Float   `json:"SpotPriceLimit" xml:"SpotPriceLimit"`
			ResourceGroupId         string          `json:"ResourceGroupId" xml:"ResourceGroupId"`
			KeyPairName             string          `json:"KeyPairName" xml:"KeyPairName"`
			Recyclable              request.Boolean `json:"Recyclable" xml:"Recyclable"`
			...
			EipAddress struct {
				...
				InternetChargeType   string          `json:"InternetChargeType" xml:"InternetChargeType"`
				IsSupportUnassociate request.Boolean `json:"IsSupportUnassociate" xml:"IsSupportUnassociate"`
