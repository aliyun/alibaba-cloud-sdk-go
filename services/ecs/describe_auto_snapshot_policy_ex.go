	...
	*responses.BaseResponse
	...
	AutoSnapshotPolicies struct {
		AutoSnapshotPolicy []struct {
			...
			RetentionDays          request.Integer `json:"RetentionDays" xml:"RetentionDays"`
			DiskNums               request.Integer `json:"DiskNums" xml:"DiskNums"`
			VolumeNums             request.Integer `json:"VolumeNums" xml:"VolumeNums"`
