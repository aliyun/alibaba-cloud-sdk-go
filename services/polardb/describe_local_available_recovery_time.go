...
// DescribeLocalAvailableRecoveryTime invokes the polardb.DescribeLocalAvailableRecoveryTime API synchronously
...
// DescribeLocalAvailableRecoveryTimeWithChan invokes the polardb.DescribeLocalAvailableRecoveryTime API asynchronously
...
// DescribeLocalAvailableRecoveryTimeWithCallback invokes the polardb.DescribeLocalAvailableRecoveryTime API asynchronously
...
func CreateDescribeLocalAvailableRecoveryTimeRequest() (request *DescribeLocalAvailableRecoveryTimeRequest) {
	...
	request.InitWithApiInfo("polardb", "2017-08-01", "DescribeLocalAvailableRecoveryTime", "polardb", "openAPI")
