...
type DescribeDBClusterVersionResponse struct {
	*responses.BaseResponse
	...
	DBInnerRevisionVersion                  string                         `json:"DBInnerRevisionVersion" xml:"DBInnerRevisionVersion"`
	DBRevisionVersionList                   []DBRevisionVersionListItem    `json:"DBRevisionVersionList" xml:"DBRevisionVersionList"`
	ProxyRevisionVersionList                []ProxyRevisionVersionListItem `json:"ProxyRevisionVersionList" xml:"ProxyRevisionVersionList"`
}
