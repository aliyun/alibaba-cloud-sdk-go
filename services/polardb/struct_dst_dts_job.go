...
// DstDtsJob is a nested struct in polardb response
type DstDtsJob struct {
	...
	SourceEndpoint      string `json:"SourceEndpoint" xml:"SourceEndpoint"`
	DestinationEndpoint string `json:"DestinationEndpoint" xml:"DestinationEndpoint"`
}
