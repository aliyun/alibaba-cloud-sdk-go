...
// CancelActiveOperationTasks invokes the r_kvstore.CancelActiveOperationTasks API synchronously
...
// CancelActiveOperationTasksWithChan invokes the r_kvstore.CancelActiveOperationTasks API asynchronously
...
// CancelActiveOperationTasksWithCallback invokes the r_kvstore.CancelActiveOperationTasks API asynchronously
...
func CreateCancelActiveOperationTasksRequest() (request *CancelActiveOperationTasksRequest) {
	...
	request.InitWithApiInfo("R-kvstore", "2015-01-01", "CancelActiveOperationTasks", "redisa", "openAPI")
