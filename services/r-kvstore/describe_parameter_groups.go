...
// DescribeParameterGroups invokes the r_kvstore.DescribeParameterGroups API synchronously
...
// DescribeParameterGroupsWithChan invokes the r_kvstore.DescribeParameterGroups API asynchronously
...
// DescribeParameterGroupsWithCallback invokes the r_kvstore.DescribeParameterGroups API asynchronously
...
type DescribeParameterGroupsResponse struct {
	*responses.BaseResponse
	...
	ParameterGroups []ParameterGroup `json:"ParameterGroups" xml:"ParameterGroups"`
}
...
func CreateDescribeParameterGroupsRequest() (request *DescribeParameterGroupsRequest) {
	...
	request.InitWithApiInfo("R-kvstore", "2015-01-01", "DescribeParameterGroups", "redisa", "openAPI")
