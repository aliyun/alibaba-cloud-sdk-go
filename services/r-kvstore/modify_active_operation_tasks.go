...
// ModifyActiveOperationTasks invokes the r_kvstore.ModifyActiveOperationTasks API synchronously
...
// ModifyActiveOperationTasksWithChan invokes the r_kvstore.ModifyActiveOperationTasks API asynchronously
...
// ModifyActiveOperationTasksWithCallback invokes the r_kvstore.ModifyActiveOperationTasks API asynchronously
...
func CreateModifyActiveOperationTasksRequest() (request *ModifyActiveOperationTasksRequest) {
	...
	request.InitWithApiInfo("R-kvstore", "2015-01-01", "ModifyActiveOperationTasks", "redisa", "openAPI")
