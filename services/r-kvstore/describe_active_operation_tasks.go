...
// DescribeActiveOperationTasks invokes the r_kvstore.DescribeActiveOperationTasks API synchronously
...
// DescribeActiveOperationTasksWithChan invokes the r_kvstore.DescribeActiveOperationTasks API asynchronously
...
// DescribeActiveOperationTasksWithCallback invokes the r_kvstore.DescribeActiveOperationTasks API asynchronously
...
func CreateDescribeActiveOperationTasksRequest() (request *DescribeActiveOperationTasksRequest) {
	...
	request.InitWithApiInfo("R-kvstore", "2015-01-01", "DescribeActiveOperationTasks", "redisa", "openAPI")
