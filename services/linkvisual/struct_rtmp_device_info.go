...
// RtmpDeviceInfo is a nested struct in linkvisual response
type RtmpDeviceInfo struct {
	PullAuthKey       string `json:"PullAuthKey" xml:"PullAuthKey"`
	StreamStatus      int    `json:"StreamStatus" xml:"StreamStatus"`
	PushUrlSample     string `json:"PushUrlSample" xml:"PushUrlSample"`
