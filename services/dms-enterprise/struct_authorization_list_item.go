...
// AuthorizationListItem is a nested struct in dms_enterprise response
type AuthorizationListItem struct {
	...
	AuthorizationId int64  `json:"AuthorizationId" xml:"AuthorizationId"`
	IdentityId      int64  `json:"IdentityId" xml:"IdentityId"`
