...
type ListUsersRequest struct {
	*requests.RpcRequest
	FuzzyUsername   string           `position:"Query" name:"FuzzyUsername"`
	SourceIp        string           `position:"Query" name:"SourceIp"`
	PageSize        requests.Integer `position:"Query" name:"PageSize"`
	Department      string           `position:"Query" name:"Department"`
	CurrentPage     requests.Integer `position:"Query" name:"CurrentPage"`
	PreciseUsername string           `position:"Query" name:"PreciseUsername"`
...
type ListUsersResponse struct {
	*responses.BaseResponse
	...
	Users     []DataList `json:"Users" xml:"Users"`
}
...
func CreateListUsersRequest() (request *ListUsersRequest) {
	...
	request.InitWithApiInfo("csas", "2023-01-20", "ListUsers", "", "")
