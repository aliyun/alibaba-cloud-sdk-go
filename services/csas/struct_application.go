...
type Application struct {
	...
	L7ProxyDomainCustom    string                                           `json:"L7ProxyDomainCustom" xml:"L7ProxyDomainCustom"`
	CreateTime             string                                           `json:"CreateTime" xml:"CreateTime"`
	BrowserAccessStatus    string                                           `json:"BrowserAccessStatus" xml:"BrowserAccessStatus"`
	Status                 string                                           `json:"Status" xml:"Status"`
	Description            string                                           `json:"Description" xml:"Description"`
	L7ProxyDomainAutomatic string                                           `json:"L7ProxyDomainAutomatic" xml:"L7ProxyDomainAutomatic"`
