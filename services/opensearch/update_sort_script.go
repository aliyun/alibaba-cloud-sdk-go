...
func CreateUpdateSortScriptRequest() (request *UpdateSortScriptRequest) {
	...
	request.InitWithApiInfo("OpenSearch", "2017-12-25", "UpdateSortScript", "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appVersionId]/sort-scripts/[scriptName]", "opensearch", "openAPI")
