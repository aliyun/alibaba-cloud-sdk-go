...
// api document: https://help.aliyun.com/api/ddoscoo/describlelayer7instancerelations.html
...
func CreateDescribleLayer7InstanceRelationsRequest() (request *DescribleLayer7InstanceRelationsRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribleLayer7InstanceRelations", "ddoscoo", "openAPI")
	return
}
