...
// api document: https://help.aliyun.com/api/ddoscoo/describedomainaccessmode.html
...
func CreateDescribeDomainAccessModeRequest() (request *DescribeDomainAccessModeRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeDomainAccessMode", "ddoscoo", "openAPI")
	return
}
