...
// api document: https://help.aliyun.com/api/ddoscoo/describeslsemptycount.html
...
func CreateDescribeSlsEmptyCountRequest() (request *DescribeSlsEmptyCountRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeSlsEmptyCount", "ddoscoo", "openAPI")
	return
}
