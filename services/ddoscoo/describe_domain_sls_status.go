...
// api document: https://help.aliyun.com/api/ddoscoo/describedomainslsstatus.html
...
func CreateDescribeDomainSlsStatusRequest() (request *DescribeDomainSlsStatusRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeDomainSlsStatus", "ddoscoo", "openAPI")
	return
}
