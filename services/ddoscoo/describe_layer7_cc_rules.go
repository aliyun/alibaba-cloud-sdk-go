...
// api document: https://help.aliyun.com/api/ddoscoo/describelayer7ccrules.html
...
func CreateDescribeLayer7CCRulesRequest() (request *DescribeLayer7CCRulesRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeLayer7CCRules", "ddoscoo", "openAPI")
	return
}
