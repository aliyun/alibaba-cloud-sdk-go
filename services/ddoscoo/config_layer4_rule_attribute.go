...
// api document: https://help.aliyun.com/api/ddoscoo/configlayer4ruleattribute.html
...
func CreateConfigLayer4RuleAttributeRequest() (request *ConfigLayer4RuleAttributeRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "ConfigLayer4RuleAttribute", "ddoscoo", "openAPI")
	return
}
