...
// api document: https://help.aliyun.com/api/ddoscoo/closedomainslsconfig.html
...
func CreateCloseDomainSlsConfigRequest() (request *CloseDomainSlsConfigRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "CloseDomainSlsConfig", "ddoscoo", "openAPI")
	return
}
