...
// api document: https://help.aliyun.com/api/ddoscoo/describebatchslsdispatchstatus.html
...
func CreateDescribeBatchSlsDispatchStatusRequest() (request *DescribeBatchSlsDispatchStatusRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeBatchSlsDispatchStatus", "ddoscoo", "openAPI")
	return
}
