...
// api document: https://help.aliyun.com/api/ddoscoo/listlayer7customports.html
...
func CreateListLayer7CustomPortsRequest() (request *ListLayer7CustomPortsRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "ListLayer7CustomPorts", "ddoscoo", "openAPI")
	return
}
