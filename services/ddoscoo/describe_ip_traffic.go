...
// DescribeIpTraffic invokes the ddoscoo.DescribeIpTraffic API synchronously
// api document: https://help.aliyun.com/api/ddoscoo/describeiptraffic.html
...
// DescribeIpTrafficWithChan invokes the ddoscoo.DescribeIpTraffic API asynchronously
// api document: https://help.aliyun.com/api/ddoscoo/describeiptraffic.html
...
// DescribeIpTrafficWithCallback invokes the ddoscoo.DescribeIpTraffic API asynchronously
// api document: https://help.aliyun.com/api/ddoscoo/describeiptraffic.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type DescribeIpTrafficRequest struct {
	*requests.RpcRequest
	...
	QueryProtocol   string           `position:"Query" name:"QueryProtocol"`
...
type DescribeIpTrafficResponse struct {
	*responses.BaseResponse
	...
	IpTrafficPoints []IpTrafficPoint `json:"IpTrafficPoints" xml:"IpTrafficPoints"`
}
...
func CreateDescribeIpTrafficRequest() (request *DescribeIpTrafficRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeIpTraffic", "ddoscoo", "openAPI")
	return
}
