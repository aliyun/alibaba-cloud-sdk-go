...
// api document: https://help.aliyun.com/api/ddoscoo/describelayer4ruleattributes.html
...
func CreateDescribeLayer4RuleAttributesRequest() (request *DescribeLayer4RuleAttributesRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeLayer4RuleAttributes", "ddoscoo", "openAPI")
	return
}
