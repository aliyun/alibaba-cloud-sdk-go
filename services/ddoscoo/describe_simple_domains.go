...
// api document: https://help.aliyun.com/api/ddoscoo/describesimpledomains.html
...
func CreateDescribeSimpleDomainsRequest() (request *DescribeSimpleDomainsRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "DescribeSimpleDomains", "ddoscoo", "openAPI")
	return
}
