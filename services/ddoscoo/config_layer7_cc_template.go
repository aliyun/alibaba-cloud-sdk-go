...
// api document: https://help.aliyun.com/api/ddoscoo/configlayer7cctemplate.html
...
func CreateConfigLayer7CCTemplateRequest() (request *ConfigLayer7CCTemplateRequest) {
	...
	request.InitWithApiInfo("ddoscoo", "2017-12-28", "ConfigLayer7CCTemplate", "ddoscoo", "openAPI")
	return
}
