...
// DescribeTagValues invokes the oceanbasepro.DescribeTagValues API synchronously
...
// DescribeTagValuesWithChan invokes the oceanbasepro.DescribeTagValues API asynchronously
...
// DescribeTagValuesWithCallback invokes the oceanbasepro.DescribeTagValues API asynchronously
...
func CreateDescribeTagValuesRequest() (request *DescribeTagValuesRequest) {
	...
	request.InitWithApiInfo("OceanBasePro", "2019-09-01", "DescribeTagValues", "oceanbase", "openAPI")
