...
// ModifyInstanceSSL invokes the oceanbasepro.ModifyInstanceSSL API synchronously
...
// ModifyInstanceSSLWithChan invokes the oceanbasepro.ModifyInstanceSSL API asynchronously
...
// ModifyInstanceSSLWithCallback invokes the oceanbasepro.ModifyInstanceSSL API asynchronously
...
type ModifyInstanceSSLRequest struct {
	*requests.RpcRequest
	...
	EnableSSL  string `position:"Body" name:"EnableSSL"`
}
...
func CreateModifyInstanceSSLRequest() (request *ModifyInstanceSSLRequest) {
	...
	request.InitWithApiInfo("OceanBasePro", "2019-09-01", "ModifyInstanceSSL", "oceanbase", "openAPI")
