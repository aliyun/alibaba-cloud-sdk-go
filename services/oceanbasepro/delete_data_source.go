...
// DeleteDataSource invokes the oceanbasepro.DeleteDataSource API synchronously
...
// DeleteDataSourceWithChan invokes the oceanbasepro.DeleteDataSource API asynchronously
...
// DeleteDataSourceWithCallback invokes the oceanbasepro.DeleteDataSource API asynchronously
...
func CreateDeleteDataSourceRequest() (request *DeleteDataSourceRequest) {
	...
	request.InitWithApiInfo("OceanBasePro", "2019-09-01", "DeleteDataSource", "oceanbase", "openAPI")
