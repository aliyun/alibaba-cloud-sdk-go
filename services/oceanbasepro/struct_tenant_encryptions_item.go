...
// TenantEncryptionsItem is a nested struct in oceanbasepro response
type TenantEncryptionsItem struct {
	TenantId         string `json:"TenantId" xml:"TenantId"`
	TenantMode       string `json:"TenantMode" xml:"TenantMode"`
	TenantName       string `json:"TenantName" xml:"TenantName"`
	EnableEncryption bool   `json:"EnableEncryption" xml:"EnableEncryption"`
