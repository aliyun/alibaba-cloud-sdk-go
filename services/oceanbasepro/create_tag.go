...
// CreateTag invokes the oceanbasepro.CreateTag API synchronously
...
// CreateTagWithChan invokes the oceanbasepro.CreateTag API asynchronously
...
// CreateTagWithCallback invokes the oceanbasepro.CreateTag API asynchronously
...
func CreateCreateTagRequest() (request *CreateTagRequest) {
	...
	request.InitWithApiInfo("OceanBasePro", "2019-09-01", "CreateTag", "oceanbase", "openAPI")
