...
// DeleteTag invokes the oceanbasepro.DeleteTag API synchronously
...
// DeleteTagWithChan invokes the oceanbasepro.DeleteTag API asynchronously
...
// DeleteTagWithCallback invokes the oceanbasepro.DeleteTag API asynchronously
...
func CreateDeleteTagRequest() (request *DeleteTagRequest) {
	...
	request.InitWithApiInfo("OceanBasePro", "2019-09-01", "DeleteTag", "oceanbase", "openAPI")
