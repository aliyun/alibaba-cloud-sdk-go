...
// DescribeUserStatistics invokes the emr.DescribeUserStatistics API synchronously
// api document: https://help.aliyun.com/api/emr/describeuserstatistics.html
func (client *Client) DescribeUserStatistics(request *DescribeUserStatisticsRequest) (response *DescribeUserStatisticsResponse, err error) {
	response = CreateDescribeUserStatisticsResponse()
	err = client.DoAction(request, response)
	return
}

// DescribeUserStatisticsWithChan invokes the emr.DescribeUserStatistics API asynchronously
// api document: https://help.aliyun.com/api/emr/describeuserstatistics.html
...
func (client *Client) DescribeUserStatisticsWithChan(request *DescribeUserStatisticsRequest) (<-chan *DescribeUserStatisticsResponse, <-chan error) {
	responseChan := make(chan *DescribeUserStatisticsResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeUserStatistics(request)
		if err != nil {
			errChan <- err
		} else {
...
// DescribeUserStatisticsWithCallback invokes the emr.DescribeUserStatistics API asynchronously
// api document: https://help.aliyun.com/api/emr/describeuserstatistics.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) DescribeUserStatisticsWithCallback(request *DescribeUserStatisticsRequest, callback func(response *DescribeUserStatisticsResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeUserStatisticsResponse
		var err error
		defer close(result)
		response, err = client.DescribeUserStatistics(request)
...
func CreateDescribeUserStatisticsRequest() (request *DescribeUserStatisticsRequest) {
	request = &DescribeUserStatisticsRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Emr", "2016-04-08", "DescribeUserStatistics", "emr", "openAPI")
	return
}
...
func CreateDescribeUserStatisticsResponse() (response *DescribeUserStatisticsResponse) {
	response = &DescribeUserStatisticsResponse{
