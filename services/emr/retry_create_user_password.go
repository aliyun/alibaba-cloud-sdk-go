...
// RetryCreateUserPassword invokes the emr.RetryCreateUserPassword API synchronously
// api document: https://help.aliyun.com/api/emr/retrycreateuserpassword.html
func (client *Client) RetryCreateUserPassword(request *RetryCreateUserPasswordRequest) (response *RetryCreateUserPasswordResponse, err error) {
	response = CreateRetryCreateUserPasswordResponse()
	err = client.DoAction(request, response)
	return
}

// RetryCreateUserPasswordWithChan invokes the emr.RetryCreateUserPassword API asynchronously
// api document: https://help.aliyun.com/api/emr/retrycreateuserpassword.html
...
func (client *Client) RetryCreateUserPasswordWithChan(request *RetryCreateUserPasswordRequest) (<-chan *RetryCreateUserPasswordResponse, <-chan error) {
	responseChan := make(chan *RetryCreateUserPasswordResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.RetryCreateUserPassword(request)
		if err != nil {
			errChan <- err
		} else {
...
// RetryCreateUserPasswordWithCallback invokes the emr.RetryCreateUserPassword API asynchronously
// api document: https://help.aliyun.com/api/emr/retrycreateuserpassword.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) RetryCreateUserPasswordWithCallback(request *RetryCreateUserPasswordRequest, callback func(response *RetryCreateUserPasswordResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *RetryCreateUserPasswordResponse
		var err error
		defer close(result)
		response, err = client.RetryCreateUserPassword(request)
...
func CreateRetryCreateUserPasswordRequest() (request *RetryCreateUserPasswordRequest) {
	request = &RetryCreateUserPasswordRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Emr", "2016-04-08", "RetryCreateUserPassword", "emr", "openAPI")
	return
}
...
func CreateRetryCreateUserPasswordResponse() (response *RetryCreateUserPasswordResponse) {
	response = &RetryCreateUserPasswordResponse{
