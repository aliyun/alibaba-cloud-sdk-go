...
type MetastoreDescribeTableResponse struct {
	*responses.BaseResponse
	...
	} `json:"Columns" xml:"Columns"`
	SerdeParameters []struct {
		Key   string `json:"Key" xml:"Key"`
		Value string `json:"Value" xml:"Value"`
	} `json:"SerdeParameters" xml:"SerdeParameters"`
	StorageDescParameters []struct {
		Key   string `json:"Key" xml:"Key"`
		Value string `json:"Value" xml:"Value"`
	} `json:"StorageDescParameters" xml:"StorageDescParameters"`
}
...
func CreateMetastoreDescribeTableRequest() (request *MetastoreDescribeTableRequest) {
	...
	request.InitWithApiInfo("Emr", "2016-04-08", "MetastoreDescribeTable", "", "")
	return
}
