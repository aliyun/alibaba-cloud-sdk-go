...
// ListMetrics invokes the cdrs.ListMetrics API synchronously
...
// ListMetricsWithChan invokes the cdrs.ListMetrics API asynchronously
...
// ListMetricsWithCallback invokes the cdrs.ListMetrics API asynchronously
...
func CreateListMetricsRequest() (request *ListMetricsRequest) {
	...
	request.InitWithApiInfo("CDRS", "2020-11-01", "ListMetrics", "", "")
