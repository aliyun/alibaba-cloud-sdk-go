...
// ListPersonTrace invokes the cdrs.ListPersonTrace API synchronously
...
// ListPersonTraceWithChan invokes the cdrs.ListPersonTrace API asynchronously
...
// ListPersonTraceWithCallback invokes the cdrs.ListPersonTrace API asynchronously
...
func CreateListPersonTraceRequest() (request *ListPersonTraceRequest) {
	...
	request.InitWithApiInfo("CDRS", "2020-11-01", "ListPersonTrace", "", "")
