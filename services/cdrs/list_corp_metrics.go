...
// ListCorpMetrics invokes the cdrs.ListCorpMetrics API synchronously
...
// ListCorpMetricsWithChan invokes the cdrs.ListCorpMetrics API asynchronously
...
// ListCorpMetricsWithCallback invokes the cdrs.ListCorpMetrics API asynchronously
...
func CreateListCorpMetricsRequest() (request *ListCorpMetricsRequest) {
	...
	request.InitWithApiInfo("CDRS", "2020-11-01", "ListCorpMetrics", "", "")
