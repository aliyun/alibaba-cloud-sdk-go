...
// AccountInListAccountsForParent is a nested struct in resourcemanager response
type AccountInListAccountsForParent struct {
	...
	Tags                TagsInListAccountsForParent `json:"Tags" xml:"Tags"`
}
