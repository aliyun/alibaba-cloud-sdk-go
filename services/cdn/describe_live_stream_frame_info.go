	...
	*responses.BaseResponse
	...
	FrameDataInfos struct {
		FrameDataModel []struct {
			...
			AudioRate  request.Float `json:"AudioRate" xml:"AudioRate"`
			AudioByte  request.Float `json:"AudioByte" xml:"AudioByte"`
			FrameRate  request.Float `json:"FrameRate" xml:"FrameRate"`
			FrameByte  request.Float `json:"FrameByte" xml:"FrameByte"`
