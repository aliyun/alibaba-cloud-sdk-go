...
type DescribeDomainMonthBillingBpsDataResponse struct {
	*responses.BaseResponse
	...
	Bandwidth95Bps         request.Float `json:"Bandwidth95Bps" xml:"Bandwidth95Bps"`
	DomesticBandwidth95Bps request.Float `json:"DomesticBandwidth95Bps" xml:"DomesticBandwidth95Bps"`
	OverseasBandwidth95Bps request.Float `json:"OverseasBandwidth95Bps" xml:"OverseasBandwidth95Bps"`
	MonthavgBps            request.Float `json:"MonthavgBps" xml:"MonthavgBps"`
	DomesticMonthavgBps    request.Float `json:"DomesticMonthavgBps" xml:"DomesticMonthavgBps"`
	OverseasMonthavgBps    request.Float `json:"OverseasMonthavgBps" xml:"OverseasMonthavgBps"`
	Month4thBps            request.Float `json:"Month4thBps" xml:"Month4thBps"`
	DomesticMonth4thBps    request.Float `json:"DomesticMonth4thBps" xml:"DomesticMonth4thBps"`
	OverseasMonth4thBps    request.Float `json:"OverseasMonth4thBps" xml:"OverseasMonth4thBps"`
}
