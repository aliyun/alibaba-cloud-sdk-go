...
type DescribeLiveSnapshotConfigResponse struct {
	*responses.BaseResponse
	...
	PageNum                      request.Integer `json:"PageNum" xml:"PageNum"`
	PageSize                     request.Integer `json:"PageSize" xml:"PageSize"`
	Order                        string          `json:"Order" xml:"Order"`
	TotalNum                     request.Integer `json:"TotalNum" xml:"TotalNum"`
	TotalPage                    request.Integer `json:"TotalPage" xml:"TotalPage"`
	LiveStreamSnapshotConfigList struct {
		LiveStreamSnapshotConfig []struct {
			DomainName         string          `json:"DomainName" xml:"DomainName"`
			AppName            string          `json:"AppName" xml:"AppName"`
			TimeInterval       request.Integer `json:"TimeInterval" xml:"TimeInterval"`
