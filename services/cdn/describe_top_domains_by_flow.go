...
type DescribeTopDomainsByFlowResponse struct {
	*responses.BaseResponse
	...
	DomainOnlineCount request.Integer `json:"DomainOnlineCount" xml:"DomainOnlineCount"`
	TopDomains        struct {
		TopDomain []struct {
			DomainName     string          `json:"DomainName" xml:"DomainName"`
			Rank           request.Integer `json:"Rank" xml:"Rank"`
			TotalTraffic   string          `json:"TotalTraffic" xml:"TotalTraffic"`
			TrafficPercent string          `json:"TrafficPercent" xml:"TrafficPercent"`
			MaxBps         request.Integer `json:"MaxBps" xml:"MaxBps"`
			MaxBpsTime     string          `json:"MaxBpsTime" xml:"MaxBpsTime"`
			TotalAccess    request.Integer `json:"TotalAccess" xml:"TotalAccess"`
