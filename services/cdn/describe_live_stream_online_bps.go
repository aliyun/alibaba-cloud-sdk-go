...
type DescribeLiveStreamOnlineBpsResponse struct {
	*responses.BaseResponse
	...
	TotalUserNumber          request.Integer `json:"TotalUserNumber" xml:"TotalUserNumber"`
	FlvBps                   request.Float   `json:"FlvBps" xml:"FlvBps"`
	HlsBps                   request.Float   `json:"HlsBps" xml:"HlsBps"`
	LiveStreamOnlineBpsInfos struct {
		LiveStreamOnlineBpsInfo []struct {
			StreamUrl string        `json:"StreamUrl" xml:"StreamUrl"`
			UpBps     request.Float `json:"UpBps" xml:"UpBps"`
			DownBps   request.Float `json:"DownBps" xml:"DownBps"`
