...
// api document: https://help.aliyun.com/api/cas/deletecertificaterequest.html
...
func CreateDeleteCertificateRequestRequest() (request *DeleteCertificateRequestRequest) {
	...
	request.InitWithApiInfo("cas", "2020-04-07", "DeleteCertificateRequest", "cas-pack", "openAPI")
