...
// ModifyActiveOperationTasks invokes the dds.ModifyActiveOperationTasks API synchronously
...
// ModifyActiveOperationTasksWithChan invokes the dds.ModifyActiveOperationTasks API asynchronously
...
// ModifyActiveOperationTasksWithCallback invokes the dds.ModifyActiveOperationTasks API asynchronously
...
func CreateModifyActiveOperationTasksRequest() (request *ModifyActiveOperationTasksRequest) {
	...
	request.InitWithApiInfo("Dds", "2015-12-01", "ModifyActiveOperationTasks", "dds", "openAPI")
