...
// ListAccessPoints invokes the kms.ListAccessPoints API synchronously
...
// ListAccessPointsWithChan invokes the kms.ListAccessPoints API asynchronously
...
// ListAccessPointsWithCallback invokes the kms.ListAccessPoints API asynchronously
...
func CreateListAccessPointsRequest() (request *ListAccessPointsRequest) {
	...
	request.InitWithApiInfo("Kms", "2016-01-20", "ListAccessPoints", "kms", "openAPI")
