	...
	*responses.BaseResponse
	...
	SecurityPreference struct {
		LoginProfilePreference struct {
			EnableSaveMFATicket       request.Boolean `json:"EnableSaveMFATicket" xml:"EnableSaveMFATicket"`
			AllowUserToChangePassword request.Boolean `json:"AllowUserToChangePassword" xml:"AllowUserToChangePassword"`
			LoginSessionDuration      request.Integer `json:"LoginSessionDuration" xml:"LoginSessionDuration"`
		...
		AccessKeyPreference struct {
			AllowUserToManageAccessKeys request.Boolean `json:"AllowUserToManageAccessKeys" xml:"AllowUserToManageAccessKeys"`
		} `json:"AccessKeyPreference" xml:"AccessKeyPreference"`
		PublicKeyPreference struct {
			AllowUserToManagePublicKeys request.Boolean `json:"AllowUserToManagePublicKeys" xml:"AllowUserToManagePublicKeys"`
		} `json:"PublicKeyPreference" xml:"PublicKeyPreference"`
		MFAPreference struct {
			AllowUserToManageMFADevices request.Boolean `json:"AllowUserToManageMFADevices" xml:"AllowUserToManageMFADevices"`
