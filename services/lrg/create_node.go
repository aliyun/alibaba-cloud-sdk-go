...
// CreateNode invokes the lrg.CreateNode API synchronously
// api document: https://help.aliyun.com/api/lrg/createnode.html
...
// CreateNodeWithChan invokes the lrg.CreateNode API asynchronously
// api document: https://help.aliyun.com/api/lrg/createnode.html
...
// CreateNodeWithCallback invokes the lrg.CreateNode API asynchronously
// api document: https://help.aliyun.com/api/lrg/createnode.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCreateNodeRequest() (request *CreateNodeRequest) {
	...
	request.InitWithApiInfo("LRG", "2019-10-10", "CreateNode", "/api/v2/tianji/node", "", "")
