...
// StartWorkflow invokes the lrg.StartWorkflow API synchronously
// api document: https://help.aliyun.com/api/lrg/startworkflow.html
...
// StartWorkflowWithChan invokes the lrg.StartWorkflow API asynchronously
// api document: https://help.aliyun.com/api/lrg/startworkflow.html
...
// StartWorkflowWithCallback invokes the lrg.StartWorkflow API asynchronously
// api document: https://help.aliyun.com/api/lrg/startworkflow.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateStartWorkflowRequest() (request *StartWorkflowRequest) {
	...
	request.InitWithApiInfo("LRG", "2019-10-10", "StartWorkflow", "/api/v2/tianji/process/[id]?action=start", "", "")
